...
export const SidebarMainContainer = styled.aside`
  position: fixed;
  z-index: 999;
  width: 100%;
  height: 100%;
...
export const SidebarTopMenu = styled.ul`
  display: flex;
  flex-direction: column;
  list-style: none;
...
export const SidebarTopItem = styled.li`
  height: 80px;
  display: flex;
...
export const SidebarTopLink = styled.a`
  display: flex;
  align-items: center;
...
export const SidebarTopLinkHr = styled.div`
  height: 5px;
  width: 30px;
  background: #36C5F0;
  margin-top: 20px;
...
export const SidebarBottomLogo = styled.img.attrs ({
...
export const SidebarBottomP = styled.p`
font-size: 2rem;
font-weight: bolder;
color: #000;
margin-left: 10px
