...
export const FooterContainerHr = styled.div`
  width: 80%;
  height: 0.1px;
...
export const FooterContainerGrid = styled.div`
  display: flex;
  width: 90%
`;
...
export const FooterContainerFoot = styled.div`
  display: flex;
  width: 100%;
  justify-content: space-around;
`;

export const FooterContainerFootLeft = styled.div`
display: flex;
flex-direction: column;
align-items: center
`;

export const FooterContainerFootLeftTop = styled.div`
display: flex;
justify-content: space-around;
margin-bottom: 25px;
font-size: 12px;
...
export const FooterContainerFootLeftTopItem = styled.div`
  margin-right: 20px;
  cursor: pointer;
...
export const FooterBottomParagraph = styled.p`
  color: gray;
  font-size: 10px;
`;

export const Browser = styled (FaGlobe)`
  color: #fff;
  margin-right: 5px;
`;
...
export const FooterContainerFootRight = styled.div`
  display: flex;
  flex-direction: column;
`;
